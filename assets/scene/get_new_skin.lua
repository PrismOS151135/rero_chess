...
function scene.draw()
    ...
    GC.replaceTransform(SCR.xOy_m)
    GC.setColor(COLOR.D)
    GC.strokeDraw('full', 4, titleText, 0, -200 - (animTimer() or 0) * 300, 0, 2, 2, titleText:getWidth() / 2,
        titleText:getHeight() / 2)
    GC.strokeDraw('full', 4, skinNameText, 0, 200 + (animTimer() or 0) * 300, 0, 2, 2, skinNameText:getWidth() / 2,
        skinNameText:getHeight() / 2)
